"""
美股均線計算模組
複製自台股 moving_average.py，完全獨立運作
"""
...
class USMovingAverageCalculator:
    """
    美股移動平均線計算器
