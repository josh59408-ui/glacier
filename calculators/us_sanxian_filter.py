"""
美股三線開花篩選器
複製自台股 sanxian_filter.py，完全獨立運作
"""
...
from config.us_settings import US_SANXIAN_PARAMS
from calculators.us_moving_average import USMovingAverageCalculator


class USSanxianFilter:
    """
    美股三線開花篩選器
    ...
    def __init__(
        ...
        Args:
            ...
            ma55_period: MA55 週期
        """
        self.ma8_period = ma8_period or US_SANXIAN_PARAMS["ma8_period"]
        self.ma21_period = ma21_period or US_SANXIAN_PARAMS["ma21_period"]
        self.ma55_period = ma55_period or US_SANXIAN_PARAMS["ma55_period"]
    ...
    def filter(
        ...
        logger.info(f"美股三線開花篩選完成: {len(result_df)} 檔")
